...
class MY_Controller extends MX_Controller {
	...
	public $assets_ = array(
		/*Use for the Administrator folder and files
		this code is used to ge the the syles and
	...
	public function load_page($page, $data = array()){
		$data['__assets__'] = $this->assets_;
      	$this->load->view('administrator/includes/head',$data);
      	$this->load->view($page, $data);
      	$this->load->view('administrator/includes/footer',$data);
    }
	public function load_user_page($page, $data = array()){
		$data['__assets__'] = $this->assets_;
      	$this->load->view('administrator/includes/head',$data);
